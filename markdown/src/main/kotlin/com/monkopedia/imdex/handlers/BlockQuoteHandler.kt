...
import com.monkopedia.imdex.ImdexNodeType.BLOCK_QUOTE
import com.monkopedia.imdex.NodeHandler
import com.monkopedia.imdex.ParsingState
import com.vladsch.flexmark.ast.BlockQuote

object BlockQuoteHandler : NodeHandler<BlockQuote> {
    override suspend fun onNode(
        ...
        state.withHolder(quote, handleChildren)
        state.handler.children.add(quote)
    }
}
